...
Notice the `DataFrame` above includes all reaches and nodes, resulting in many columns. You can obtain more manageable DataFrames by calling `read()` on data subsets (e.g., by location or quantity).
