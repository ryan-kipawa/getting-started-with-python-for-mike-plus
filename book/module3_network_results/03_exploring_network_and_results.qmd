...
Catchments are handled similarly to nodes but are typically found in a separate result file, often related to rainfall-runoff simulations.
...
::: {.callout-note}
Reaches also allow sequential indexing (e.g., `[0]` for the first gridpoint, `[-1]` for the last) for convenient access to gridpoints. This is *different* than Python dictionaries.
:::
...
[Video: example showing autocompletion]