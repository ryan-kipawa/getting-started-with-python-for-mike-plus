...
There's several useful packages for engineering and science. This course will use the following packages:

- [NumPy](https://numpy.org/)
- [Maptlotlib](https://matplotlib.org/)
...
Use *vectorized* operations on arrays. For example, multiple all elements of the previous array by 2:
```{python}
my_array * 2
```
