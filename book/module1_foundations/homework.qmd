...
- [Jupyter Notebook covering Python basics](data/homework/python_basics.ipynb){download=python_basics}
- [Jupyter Notebook covering NumPy](data/homework/numpy.ipynb){download=numpy}
- [Jupyter Notebook covering Pandas](data/homework/pandas.ipynb){download=pandas}
- [Jupyter Notebook covering Matplotlib](data/homework/matplotlib.ipynb){download=matplotlib}