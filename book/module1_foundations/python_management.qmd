...
There's several tools for managing Python and packages together. Two common options are:

1. [uv](https://docs.astral.sh/uv/)
2. [Miniforge](https://conda-forge.org/download/)

This course uses *uv*. Please install *uv* according to their [official installation instructions](https://docs.astral.sh/uv/getting-started/installation/). Use the "standalone installed" for Windows.
...
```powershell
uv pip install --ugprade mikeio
```

### Install specific package versions

Occaisonally there's a need to install an older version of a package, which can be done as follows:
